...
export const UPDATE_USER = gql`
    mutation UpdateUser($userID: ID!, $userInput: UserInput!) {
        updatedUser: updateUser(userID: $userID, userInput: $userInput) {
            ...UserDetail
        }
    }
    ${USER_DATA}
...
export const GET_APPOINTMENTS = gql`
    query GetAppointments($query: AppointmentFilter, $future: Boolean = false) {
        appointments: appointments(filter: $query, future: $future) {
            ...AppointmentDetail
        }
    }
    ${APPOINTMENT_DATA}
...
export const GET_ACCOUNT_RECOVERY_TOKEN = gql`
    query AccountRecoveryToken($username: String!) {
        token: accountRecoveryToken(username: $username)
    }
`;

export const RECOVER_ACCOUNT = gql`
    query RecoveryAccount($accountRecoveryToken: String!) {
        token: recoverAccount(accountRecoveryToken: $accountRecoveryToken)
    }
`;